...
describe("Phase 1 release rehearsal", () => {
  ...
  it("reconciles quality, deployment, smoke and rollback evidence to one commit", () => expect(validateReleaseCandidate()).toMatchObject({ gate: "C", status: "DEPLOYED", releaseId: "RC-004", shortCommit: "f4583d8", passedGateCount: 6, browserJourneyCount: 8, rollbackReady: true }));
