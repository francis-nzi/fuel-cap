...
export default defineConfig({
  ...
  webServer: [
    { command: "corepack pnpm dev --port 3000", url: "http://127.0.0.1:3000/api/health", reuseExistingServer: !process.env.CI, timeout: 120_000, env: { DEMO_CONTROL_ORIGIN: "http://127.0.0.1:3001", NEXT_PUBLIC_SUPABASE_URL: "http://127.0.0.1:54321", NEXT_PUBLIC_SUPABASE_PUBLISHABLE_KEY: "demo-publishable-key-not-live" } },
